...
// // const name = window.prompt("Enter your name ? ") || "3bdallah";
...
//    const numberOne = parseFloat(window.prompt("Enter Numbre One "));
//    const numberTwo = parseFloat( window.prompt("Enter Numbre Two "));
